...
const handleCollapsable = (ev) => {
  ...
  <header className="header">
      <div className="header__container">
          <img className="header__container--logoProfile" src={logoAWS} alt="logo awespne logo-awesome-profile-cards" />
      </div>
  </header>
      ...
      <article className="preview__box js_previewBox palette-1">
        ...
        <nav>
          <ul className="preview__socialIcons">
            <li>
              <a href="" target="_blank" className="preview__icon js_previewPhone js_preview_icon">
                <i className="fa-solid fa-mobile-screen-button js_icons"></i>
              </a>
            </li>
            <li>
              <a href="" target="_blank" className="preview__icon js_previewEmail js_preview_icon">
                <i className="fa-regular fa-envelope js_icons"></i>
              </a>
            </li>

            <li>
              <a href="" target="_blank" className="preview__icon js_previewLinkedin js_preview_icon">
                <i className="fa-brands fa-linkedin-in js_icons"></i>
              </a>
            </li>
            <li>
              <a href="" target="_blank" className="preview__icon js_previewGithub js_preview_icon">
    ...
    <form className="form">
        ...
        <div className={`desing__div js_divDesign ${collapsable}`}>
          ...
          <div className="desing__div--colors">
            <label className="familyColor1" htmlFor="familyColor1">
              <input className="js_inputRadio js_inputRadio1" id="familyColor1 " type="radio" value="1" name="color" />
            ...
            <label className="familyColor2" htmlFor="familyColor2">
              <input className="js_inputRadio js_inputRadio2" id="familyColor2" type="radio" value="2" name="color" />
            ...
            <label className="familyColor3" htmlFor="familyColor3">
              <input className="js_inputRadio js_inputRadio3" id="familyColor3" type="radio" value="3" name="color" />
      ...
      <fieldset className="fill js_allInputs">
        ...
        <div className= {`fillInput js_divFill ${collapsable}`}>
          ...
          <label className="fillInput__label" htmlFor="job">Puesto</label>
          <input className="fillInput__input js_inputJob" type="text" id="job" name="job" placeholder="Ej : Jedi Knight" required="" />
          ...
          <label className="fillInput__label" htmlFor="Email">Email</label>
          <input className="fillInput__input js_inputEmail" type="mail" id="Email" name="email" placeholder="Ej : skyguy@gmail.com" required="" pattern="[a-zA-Z0-9!#$%&amp;'*_+-]([\.]?[a-zA-Z0-9!#$%&amp;'*_+-])+@[a-zA-Z0-9]([^@&amp;%$\/()=?¿!.,:;]|\d)+[a-zA-Z0-9][\.][a-zA-Z]{2,4}([\.][a-zA-Z]{2})?" />

          <label className="fillInput__label" htmlFor="tel">Teléfono</label>
          <input className="fillInput__input js_inputPhone" type="tel" id="tel" name="phone" placeholder="Ej : 555-55-55-55" required="" maxlength="9" />
          <label className="fillInput__label" htmlFor="linkedin">Linkedin</label>
          <input className="fillInput__input js_inputLinkedin" type="url" id="linkedin" name="linkedin" placeholder="Ej : @linkedin" required="" />

          <label className="fillInput__label" htmlFor="github">Github</label>
          <input className="fillInput__input js_inputGithub" type="url" id="github" name="github" placeholder="Ej : @sky.guy" required="" />
        </div>
      </fieldset>
      <fieldset className="share">
        ...
        <section className={`js_divShare collapsed ${collapsable}`}>
          ...
          <div className="card js_cardShare collapsed">
            ...
            <a href="" className="card__link js_url" target="_blank"> </a>

            <div className="card__twitter">
              <i className="fa-brands fa-twitter card__twitter--icon"></i>

              <a className="card__twitter--link js_shareTwitter" href="" target="_blank">
